...
```{r densityPlot, echo=FALSE, cache=TRUE, fig.cap=figRef("densityPlot", "Distribution of probe intensities.")}
...
sig.data.long <- sig.data.long[c("sample", "treatment", "probe", "intensity")]
