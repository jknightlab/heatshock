...
plink --bfile data/hapmap_YRI_r23a_filtered --out tmp/hapmap_yri.snp_flt --keep tmp/sample.lst --maf 0.1 --geno 0.1 --hwe 1e-4 --split-x b36 no-fail --autosome-xy --make-bed --silent
```
...
remainSNPs <- R.utils::countLines("tmp/hapmap_yri.bim")
```
