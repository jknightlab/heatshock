...
ggplot(sig.pc, aes(x=PC1, y=PC2)) +  
	 geom_polygon(data=clusterOp1[clusterOp1Bound_1_2, ], alpha=0.7, fill="lightgrey", colour="grey") +
	 geom_polygon(data=clusterOp2[clusterOp2Bound_1_2, ], alpha=0.7, fill="pink", colour="red") +
	 geom_polygon(data=clusterChip1[clusterChip1Bound_1_2, ], alpha=0.7, fill="yellow", colour="orange") +
	 geom_polygon(data=clusterChip2[clusterChip2Bound_1_2, ], alpha=0.7, fill="lightgreen", colour="green") +
	 geom_polygon(data=clusterChip3[clusterChip3Bound_1_2, ], alpha=0.7, fill="lightblue", colour="blue") +
