...
plsPlot <- function(plsComp, genotype, groups="treatment"){
...
system(paste("tar -czf tmp/eQTL_result.tar.gz -C tmp eQTL_basal_analysis eQTL_stim_analysis", paste(paste0("eQTL_", selGenes_basal$Symbol,"_basal_analysis"), collapse=" "), paste(paste0("eQTL_", selGenes_basal$Symbol,"_stim_analysis"), collapse=" ")))
```
