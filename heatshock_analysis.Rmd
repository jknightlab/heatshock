...
compared to those that don't (`r figRef("pwmPlot")`). Also note that
there is no obvious difference in scores for novel and established heat shock response genes.

```{r pwmPlot, cache=FALSE, fig.cap=figRef("pwmPlot", "Distribution of p-values for HSF1 motif score.")}
ggplot(dplyr::filter(r_promoter, expr=="up"), 
