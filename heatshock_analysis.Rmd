...
system("tar -czf tmp/topGO.tar.gz tmp/topGO_upregulated.tab tmp/topGO_downregulated.tab")
```
...
system("tar -czf tmp/reQTL_input.tar.gz selected_probes_pos.tab snp_loc_GRCh37.tab selected_probes_fc.tab genotypes_GRCh37.tab covariates.tab")
```
...
system("tar -czf tmp/eQTL_input.tar.gz tmp/selected_probes_pos.tab tmp/snp_loc_GRCh37.tab tmp/selected_probes_stim_expr.tab tmp/selected_probes_basal_expr.tab tmp/covar_expr_stim.tab tmp/covar_expr_basal.tab")
```
...
if(file.exists("heatshock_analysis_files/figure-html") && !file.exists("tmp/figures_png.tar.gz")){
  system("tar -czf tmp/figures_png.tar.gz heatshock_analysis_files/figure-html/*")
}
if(file.exists("heatshock_analysis_files/figure-latex") && !file.exists("tmp/figures_pdf.tar.gz")){
  system("tar -czf tmp/figures_pdf.tar.gz heatshock_analysis_files/figure-latex/*")
}
```
