...
set.caption(tabRef("transStimGenes", "List of genes with strongest evidence for trans associations between gene expression in the basal state and SNPs upstream of HSF1 and HSF2."))
pander(tab)
```
