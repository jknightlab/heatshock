...
This estimates the F~ST~ for rs12207548 to be `r pander(fst['rs12207548'])`. Of the `r pander(sum(!is.na(fst)))` SNPs tested
`r pander(round(sum(fst > fst['rs12207548'], na.rm=TRUE)/sum(!is.na(fst)) * 100), 2)`% have a more extreme value.
