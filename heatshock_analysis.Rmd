...
expressed genes (FDR < `r fdrCut` and fold change > `r 2^fcCut`) on chromosome 7.

```{r candGenes}
selectedGenes <- dplyr::filter(selectedGenes, chrom == "chr7") 
```
...
me <- Matrix_eQTL_main(
    ...
    gene = pheno,
    cvrt = covar,
    output_file_name = "tmp/reQTL_analysis",
    pvOutputThreshold = 1,
