...
pander(head(dplyr::select(geneP_stim, -ArrayAddress, -NuID)), 
       emphasize.rows=which(geneP_stim$Symbol %in% stimGenes$Symbol))
```
...
pander(head(dplyr::select(geneP_basal, -ArrayAddress, -NuID)),
       emphasize.rows=which(geneP_basal$Symbol %in% basalGenes$Symbol))
```
