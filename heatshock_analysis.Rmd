...
Annotations for all probes were obtained via the *illuminaHumanv4.db* Bioconductor
...
```{r probeQual}
annot <- illuminaHumanv4fullReannotation()
annot <- subset(annot, 
...
limmaTable <- inner_join(select(annot, ArrayAddress, NuID, SymbolReannotated),
		limmaTable)
```
