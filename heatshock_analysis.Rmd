...
clusterOp<- dplyr::filter(sig.pc, Sentrix_ID %in% c(526786720, 526786721))
...
clusterChip4 <- dplyr::filter(sig.pc, Sentrix_ID == 536403760)
...
ggplot(sig.pc, aes(x=PC1, y=PC3)) +  
     ...
     geom_point(aes( colour=as.character(Sentrix_ID), shape=`Operator initial cRNA`), size=3) + 
     theme_bw() + scale_colour_discrete("BeadChip") + scale_shape_discrete("RNA amplified by")
```
