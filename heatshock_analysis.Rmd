...
set.caption(tabRef("eQTLstimGenes", "List of genes with strongest evidence for genetic modulation of gene expression after heat shock treatment."))
pander(head(dplyr::select(geneP_stim, -ArrayAddress, -NuID)))
```

```{r eQTLBasalGeneTable, cache=FALSE}
set.caption(tabRef("eQTLbasalGenes", "List of genes with strongest evidence for genetic modulation of gene expression in basal state."))
