...
merged, producing a final grouping into four clusters (`r figRef("vsnPCA2")`).


```{r exprClust}
exprDist <- dist(t(sig.data.norm))
exprClust <- hclust(exprDist, method="ward.D2")
```

```{r clustPlot, cache=FALSE, fig.cap=figRef("exprDendro", paste("Dendrogram of gene expression samples. Colours of leaves correspond to clusters in", figRef("vsnPCA")))}
