...
```{r treatPLSpval, cache=FALSE, fig.cap=figRef("permPval", past0("P-values observed after permutation of global response phenotype for SNP ", dimnames(assoc$Result)[[1]][1], ".")}
