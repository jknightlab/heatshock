...
system("gzip -c tmp/snp_loc_GRCh37.tab > tmp/snp_loc_GRCh37.tab.gz", intern=TRUE)
```
...
system("gzip -c tmp/genotypes_GRh37.tab > tmp/genotypes_GRCh37.tab.gz", intern=TRUE)
```
...
system("gzip -c tmp/covariates.tab > tmp/covariates.tab.gz", intern=TRUE)
```
