...
two PLS omponents account for `r format(sum(plsFit$R2[1:2]*100), nsmall=1, digits=2)`% 
...
coef <- assoc$Results[1:4, , 1]
coef[, "JointModel"] <- assoc$adj.p.val[1:4]
...
genotypes <- cbind(genotypes, t(geno$bed[dimnames(assoc$Results)[[1]][1:10],]))
