...
knownList$strict <- union(knownList$extended, names(queryFound))
...
pander(GenTable(tg_pls$up, cluster1=resultPlsUp, cluster2=resultPlsDown, topNodes=20, orderBy="cluster1"))
```
...
pander(GenTable(tg_pls$down, cluster2=resultPlsDown, cluster1=resultPlsUp, topNodes=20, orderBy="cluster2"))
```
