...
```{r compareGenes}
stimGenes <- dplyr::filter(geneP_stim, Gene.FDR < 0.05 & 
                             !Symbol %in% dplyr::filter(geneP_basal, Gene.FDR < 0.5)$Symbol)
basalGenes <- dplyr::filter(geneP_basal, Gene.FDR < 0.05 & 
                             !Symbol %in% dplyr::filter(geneP_stim, Gene.FDR < 0.5)$Symbol)
```
