...
A PubMed search for articles mentioning the remaining genes in the context
of heat shock response was carried out.
...
system("tar -czf tmp/gene_annotation.tar.gz tmp/heatshock_pmid.txt tmp/heatshock_novel.tab")
```
...
## Associations with copy number variations

```{r loadCNV}
cnv <- read_tsv("data/yri_cnv.tab")
cnv <- dplyr::select(cnv, one_of(c("Gene", colnames(selectedFC))))
```
