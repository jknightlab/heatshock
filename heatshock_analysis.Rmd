...
`r figRef("plsGenePlot")` shows two examples of genotypes associating with the
...
set.caption(tabRef("topGeneSNPs_stim", paste("Top eSNPs for", stimGenenes$Gene[1], "following heat shock.")))
tab <- head(meGene_stim[[stimGenes$NuID[1]]]$all$eqtls, min(geneSNPcount_stim[1], 20))
tab$gene <- stimGenenes$Gene[1]
pander(tab)
```
