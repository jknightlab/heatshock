...
```{r treatPSLplot, cache=FALSE, fig.cap=figRef("treatPCA", "Samples separate clearly by treatment, showing a consistent global effect on gene expression from heat shock.")}
treatAvg <- data.frame(do.call(rbind, by(dplyr::select(pslComp, t1, t2), pslComp$Treatment, colMeans)))
