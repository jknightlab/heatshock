...
for the top 20 results). Of these `r nrow(filter(limmaTable, adj.P.Val < 0.01 & abs(logFC) > 0.5))` 
have a log fold change of at least 0.5. `r figRef("volcano")` shows a smoothed volcano plot highlighting
