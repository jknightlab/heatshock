...
plink --bfile data/hapmap_YRI_r23a_filtered --out hapmap_yri --keep data/sample.lst --maf 0.1 --geno 0.1 --hwe 1e-4 --split-x b36 no-fail --autosome-xy --make-bed --silent
```
