...
fullPlot <- ggplot(tbl, aes(x=Expected, y=Significant)) + 
    ...
    theme_bw()
multiplot(fullPlot + theme(legend.position="none"), fullPlot  + xlim(0,50) + ylim(0,100) + 
            theme(axis.text.y=element_blank(),axis.ticks.y=element_blank() + axis.title.y=element_blank()), cols=2)
```
